...
var showV = function (dictShow) {
    return function (dictShow1) {
        return new Data_Show.Show(function (v) {
            ...
            throw new Error("Failed pattern match at Data.Validation.Semiring line 67, column 10 - line 71, column 1: " + [ v.constructor.name ]);
        });
    };
};
...
var traversableV = new Data_Traversable.Traversable(function () {
    ...
    return unV(function ($69) {
        return Control_Applicative.pure(dictApplicative)(V(Data_Either.Left.create($69)));
    })(Data_Functor.map((dictApplicative.Apply0()).Functor0())(function ($70) {
        return V(Data_Either.Right.create($70));
    }));
}, function (dictApplicative) {
    return function (f) {
        return unV(function ($71) {
            return Control_Applicative.pure(dictApplicative)(V(Data_Either.Left.create($71)));
        })(function ($72) {
            return Data_Functor.map((dictApplicative.Apply0()).Functor0())(function ($73) {
